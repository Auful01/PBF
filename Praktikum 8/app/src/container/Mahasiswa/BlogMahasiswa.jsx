...
class BlogMahasiswa extends Component {
    ...
    ambilDataDariServerAPI = () => {
        API.getMahasiswa().then(result => { this.setState({ listMhs: result }) })
    }
    ...
    handleHapusMahasiswa = (data) => {
        API.deleteMahasiswa(data).then(res => { this.ambilDataDariServerAPI() })
    }
    ...
    handleTombolSimpan = () => {
        API.postMahasiswa(this.state.insertMhs).then(res => { this.ambilDataDariServerAPI() })
    }
